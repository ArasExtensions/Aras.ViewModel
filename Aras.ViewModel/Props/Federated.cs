...
{
    [Attributes.ClientControl("Aras.View.Properties.Federated")]
    public class Federated : Property
    {
        ...
        private void SetValue(System.String Value)
        {
            ...
            if (this.Binding != null)
            {
                ...
                ((Model.Properties.Federated)this.Binding).Value = this.Value;
        ...
        protected override void CheckBinding(object Binding)
        {
            ...
            if (Binding != null)
            {
                ...
                {
                    throw new Model.Exceptions.ArgumentException("Binding must be of type Aras.Model.Properties.Federated");
                }
            }
        }
        ...
        protected override void AfterBindingChanged()
        {
            ...
            if (this.Binding != null)
            {
                this.Value = (System.String)((Model.Properties.Federated)this.Binding).Value;
            }
            else
            {
                this.Value = null;
