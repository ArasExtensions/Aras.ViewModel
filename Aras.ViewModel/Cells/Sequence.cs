...
namespace Aras.ViewModel.Cells
{
    public class Sequence : Cell
    {
        ...
        protected override void CheckBinding(object Binding)
        {
            ...
            {
                throw new Model.Exceptions.ArgumentException("Binding must be Aras.Model.Properties.Sequence");
            }
        }

        internal Sequence(Column Column, Row Row)
            :base(Column, Row)
        {
